...
function BasketNavbar() {
  ...
  return (
    <nav className="flex fixed top-0 inset-x-0 rounded items-center justify-between flex-wrap bg-purple-600 p-4 m-4">
      ...
      <button className="bg-purple-200 hover:bg-purple-400 text-gray-800 font-bold py-2 px-4 m-4 rounded">
      ...
      <div className="block float-right lg:flex lg:items-right lg:w-auto">
        <div className="float-right mr-6 text-sm lg:flex-grow">
          ...
          <div className="inline-flex my-2">
            <button
              className="bg-purple-200 hover:bg-purple-400 text-gray-800 font-bold py-2 px-4 rounded-l"
              onClick={ (() => dispatch(updateCurrency('USD'))) }
            >
              USD
            </button>
            <button
              className="bg-purple-200 hover:bg-purple-400 text-gray-800 font-bold py-2 px-4"
              onClick={ (() => dispatch(updateCurrency('EUR'))) }
            >
              EUR
            </button>
            <button
              className="bg-purple-200 hover:bg-purple-400 text-gray-800 font-bold py-2 px-4 rounded-r"
        ...
        <div className="text-sm lg:flex-grow my-2 mr-6">
          ...
          <div className="inline-flex">
            <button
              className="sort-price bg-purple-200 hover:bg-purple-400 text-gray-800 font-bold py-2 px-4 rounded-l"
              onClick={ (() => dispatch(updateSorting('price'))) }
            >
              By price
            </button>
            <button
              className="sort-name bg-purple-200 hover:bg-purple-400 text-gray-800 font-bold py-2 px-4 rounded-r"
