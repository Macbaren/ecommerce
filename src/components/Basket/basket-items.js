  ...
  return (
    <div className="flex flex-wrap mt-40 mb-20 ml-6" >
      {countItems.length > 0
        ...
        :
        <div className="flex mx-auto my-20 bg-blue-100 border-t-4 border-blue-500 rounded-b text-blue-900 px-4 py-3 shadow-md" role="alert">
          <div className="flex">
            ...
            <div>
              <p className="font-bold">There is no items here yet</p>
              <p className="text-sm">Go back and start shopping</p>
            </div>
          </div>
        </div>
        }
